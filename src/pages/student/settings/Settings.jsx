      ...
      <StartScreen>
        <div className={styles.Settings}>
          <div className={styles.SettingsContainer}>
            <h1 className={styles.SettingsTitle}>Configuración de usuario</h1>
            ...
            <div className={styles.SettingsRow}>
              <div className={styles.SettingsLabel}>Nombre de usuario</div>
              <input
                type="text"
                name="username"
            ...
            <div className={styles.SettingsRow}>
              <div className={styles.SettingsLabel}>Nombre completo</div>
              <input
                type="password"
                name="username"
                className={styles.SettingsInput}
