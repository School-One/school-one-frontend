            ...
            <StartScreen teacher={user.rol}>
                <Sidebar step={'Home'}>
                    ...
                    <div className="row mt-3">
                        <div className={`${user.rol === 'Profesor' ? 'col-md-12' : 'col-md-8'}`}>
                            <Homeworks id={id} />
                        </div>
                        {
                                ...
                                <div className="col-md-4">
                                    <div className="col-md-12" style={{backgroundColor: '#E6E6E6', borderRadius: '1rem'}}>
                                        ...
                                        <div className="py-2 d-flex justify-content-center">
                                            <img src={DefaultPhoto} alt="Teacher_img" className="img-fluid mb-3 rounded-pill" />
                                        </div>
                                        ...
                                        <div className="py-3 m-3">
                                            ...
                                            <div className="mt-3" style={{backgroundColor: '#2F2E41', borderRadius: '3rem', cursor: 'pointer'}} onClick={() => setModalOpen(true)} id="btn-detail">
                                                <div className="p-1 text-center text-white">
                                                    <h3>Detalles</h3>
                                                </div>
                                            </div>
                        ...
                        <DetailModal isOpen={modalOpen} onClose={() => setModalOpen(false)} teacher={teacher} />
                    </div>    
                </Sidebar>
            </StartScreen>
        )
