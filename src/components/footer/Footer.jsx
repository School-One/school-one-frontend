        ...
        <div className="row justify-content-evenly">
          <div className="col-md-3 mt-4 footer-section__card">
            ...
            <p className="text-white">
              Sophiano College liderada por un equipo humano de profesionales
              calificados, idóneos y comprometidos que propician la formación
          ...
          <div className="col-md-3 mt-4">
            ...
            <p>
              <a href="tel:929612594" className="footer-section__link">
                📞 929 612 594
              </a>
            </p>
            <p>
              <a
                ...
                className="footer-section__link"
              >
                🌎 Mz. C-4 LT. 1 y 2 -11 A.A. Cáceres, Ventanilla - Callao
                (Frente a Plaza Vea y al costado del banco Interbank)
              </a>
            </p>
          </div>
        </div>
